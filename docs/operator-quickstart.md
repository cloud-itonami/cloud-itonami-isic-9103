# Operator Quickstart — Botanical and zoological gardens and nature reserves activi...

Shortest path from clone to a verified local dry-run for **ISIC 9103** (`cloud-itonami-isic-9103`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9103.git
cd cloud-itonami-isic-9103
```
...
- Blueprint governor key: `conservation-governor`
- Likely source path: `conservation.governor.cljc`
